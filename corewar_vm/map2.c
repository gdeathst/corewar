...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2021/05/09 12:25:51 by mevelyne          #+#    #+#             */
/*   Updated: 2021/05/09 12:25:52 by mevelyne         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	set_chmps_cycle(int k, t_chmp *tmp_chmp, t_bs *bs, t_proc *tmp_proc)
{
	k = -1;
...
void	set_chmps_with_flag_num(t_bs *bs, int k)
{
	...
	while (tmp_chmp)
	{
		...
		if (tmp_chmp->flag_num != 0)
		{
			...
			set_chmps_cycle(k, tmp_chmp, bs, tmp_proc);
		}
