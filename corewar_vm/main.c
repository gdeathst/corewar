...
///*                                                +#+#+#+#+#+   +#+           */
///*   Created: 2021/05/09 12:25:39 by mevelyne          #+#    #+#             */
///*   Updated: 2021/05/09 12:25:40 by mevelyne         ###   ########.fr       */
///*                                                                            */
///* ************************************************************************** */
...
{
	return (ft_strequ(av[*index], "-dump")
		|| ft_strequ(av[*index], "-print")
		|| ft_strequ(av[*index], "-n")
		|| ft_strequ(av[*index], "-v")
...
//
//void	ft_check_args_sprint(t_bs *base, char **av, int ac, int i)
//{
//	if (i < ac)
//	{
//		parse_flag_num(&base, av, ac, &i);
...
//		while (i < ac && check_flags_corewar(av, &i))
//		{
//			ft_check_args_sprint(base, av, ac, i);
//		}
//		if (i < ac && !check_flags_corewar(av, &i))
//		{
//			a_n_c(&base->list_champs, 0, &base->list_proc, av[i]);
