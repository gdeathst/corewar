...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2021/05/09 12:25:43 by mevelyne          #+#    #+#             */
/*   Updated: 2021/05/09 12:25:44 by mevelyne         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	global_cycles_without_visual2(t_bs *bs, unsigned int *cycle_to_die_curr,
	unsigned int *max_check, long *cycle_to_die)
{
	...
	if (check_cycle_to_die(bs, cycle_to_die, max_check, cycle_to_die_curr) == 0)
		return (-1);
	return (1);
}
...
void	global_cycles_without_visual(t_bs *bs)
{
	...
	{
		if (global_cycles_without_visual2(bs, &cycle_to_die_curr, \
		&max_check, &cycle_to_die) == -1)
			break ;
	}
	++g_count;
